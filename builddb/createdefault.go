...
func DefaultDatabase(db *sql.DB, dbPath string) {
	if db == nil {
	...
	Laissez-vous inspirer par les expériences des autres et planifiez votre prochaine évasion.')`)
		...
		execAndLog(`INSERT INTO type (type) VALUES ('ADMIN')`)
		execAndLog(`INSERT INTO type (type) VALUES ('REQUEST')`)
		execAndLog(`INSERT INTO type (type) VALUES ('ANSWER')`)
		execAndLog(`INSERT INTO type (type) VALUES ('MESSAGE')`)
		execAndLog(`INSERT INTO type (type) VALUES ('INTERACTION')`)
	}
}
