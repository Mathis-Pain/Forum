...
func DefaultDatabase(db *sql.DB) {
	...
	'Besoin de booster votre productivité ? De changer une habitude qui vous pourrit la vie ? Envie de donner des conseils aux autres pour profiter au mieux de son quotidien ?')`)
	execAndLog(`INSERT INTO category (name, description) VALUES ('Alimentation et exercice', 
	'Être bien dans sa tête ne suffit pas. "Un esprit sain dans un corps sain" implique aussi de bien gérer son alimentation et son exercice pour éviter les excès ou les manques d''un côté ou de l''autre. Venez demander des conseils ou partager vos astuces !')`)
	execAndLog(`INSERT INTO category (name, description) VALUES ('Gérer son budget', 
	'L''argent n''est pas facile pour tout le monde. Que vous soyez extrêmement doué pour le gérer ou, au contraire, que vous ayez besoin d''aide pour ne pas vous retrouver dépassé, c''est ici !')`)
	execAndLog(`INSERT INTO category (name, description) VALUES ('Minimalisme et écologie', 
	'Ce n''est pas toujours facile de faire la part des choses. Venez trouver ou donner des petites astuces pour un quotidien plus sain, pour vous comme pour la planète.')`)
	execAndLog(`INSERT INTO category (name, description) VALUES ('Améliorer sa vie sociale', 
	'Communiquer n''est pas un don inné. Tout le monde peut avoir besoin de conseil pour gérer une situation, se sentir mieux dans ses rapports avec son entourage ou simplement s''adapter à de nouvelles personnes.')`)
